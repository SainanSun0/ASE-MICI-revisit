...
CtrlVar.Distribute=true;                       % linear system is solved using distributed arrays.
% Again, the speedup is problem dependent and never particularly large for low density sparse matrices as typically generated by Ua and other FE programs.
...
UserVar.oceanfile='ocean_local_PIGL_median.mat';
